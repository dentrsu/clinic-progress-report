-- Migration: Update Oracle RPC to include patient milestone stagnation risk
-- Date: 2026-03-06
...
begin
  ...
  -- Patients assigned > 14 days without Full Chart, or > 30 days since Full Chart without TP Approved
  ...
  -- 5) Verified velocity: total verified units over last 4/8 weeks 
  select
